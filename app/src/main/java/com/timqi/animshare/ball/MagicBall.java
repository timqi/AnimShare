...
public class MagicBall extends View {
  ...
  public MagicBall(Context context, AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public MagicBall(Context context, AttributeSet attrs, int defStyleAttr) {
